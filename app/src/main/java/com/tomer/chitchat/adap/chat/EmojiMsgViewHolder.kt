...
class EmojiMsgViewHolder(
    private val b: MsgItemEmojiBinding,
    ...
    override fun bind(mod: UiMsgModal) {
        ...
        if (mod.isSent) {
            ...
            b.emojiTv.gravity = Gravity.END
            b.imgMsgStatus.visibility = View.VISIBLE
            b.emojiTv.setTextColor(ContextCompat.getColor(context, R.color.fore))
        } else {
            ...
            b.emojiTv.gravity = Gravity.START
            b.imgMsgStatus.visibility = View.GONE
            b.emojiTv.setTextColor(ContextCompat.getColor(context, R.color.white))
        }
